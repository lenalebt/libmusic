...
namespace music
{
    ...
    public:
        ...
        bool recalculateCategory(const databaseentities::Category& category, bool recalculateCategoryMembershipScores_ = true);
        ...
        bool recalculateCategoryMembershipScores(const databaseentities::Category& category);
