...
namespace music
{
    ...
    public:
        ...
        BlockingQueue<databaseentities::id_datatype>* preprocessFiles(const std::vector<std::string>& files, unsigned int threadCount = 2, ProgressCallbackCaller* callback = NULL);
